...
*Option*::            *Description*::
<tt>:app</tt>::       Specify the applications name, however it's
                      recemonded to define the translation key <tt>:'app.name'</tt>.
                      
                      Default is +RAILS_ROOT+, expects string or symbol
